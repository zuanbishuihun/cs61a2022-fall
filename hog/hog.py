...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    zero_gain = tail_points(opponent_score)
    num = num_rolls
    if zero_gain >= threshold:
        num = 0
    return num
    # END PROBLEM 10
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    if perfect_square(cur):
        cur = next_perfect_square(cur)
